...
const file_api_order_v1_order_proto_rawDesc = "" +
	...
	"/v1/orders\x12`\n" +
	"\bGetOrder\x12\x19.order.v1.GetOrderRequest\x1a\x1a.order.v1.GetOrderResponse\"\x1d\x82\xd3\xe4\x93\x02\x17\x12\x15/v1/orders/{order_id}B\x19Z\x17azushop/api/order/v1;v1b\x06proto3"
